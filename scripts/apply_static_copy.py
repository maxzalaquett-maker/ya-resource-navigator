#!/usr/bin/env python3
"""Apply deliberate, reviewed copy and categories to structured guide entries.

These overrides are written into app-data.json during the build. They are not browser-side
language transformations or inferred categories.
"""
...
FOSTER_PROGRAM_COPY = {
    "Mecklenburg LINKS": {
        "categories": ["housing", "transition", "education", "career"],
    ...
    "SaySo": {
        "categories": ["transition", "mentorship"],
    ...
    "Home4Me — LEG Up on LIFE": {
        "categories": ["transition", "career", "mentorship"],
    ...
    "Machiah's House": {
        "categories": ["transition", "education", "career", "mentorship"],
    ...
    "Livingstone College H.O.P.E. Emancipation Project": {
        "categories": ["housing", "transition", "education"],
...
def main() -> None:
    ...
    print("Applied deliberate static guide copy and categories")
